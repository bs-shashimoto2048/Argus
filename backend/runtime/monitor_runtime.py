...
class MonitorRuntime:
    def __init__(self, monitor_id: int, config: ReaderConfig, on_status, on_result=None) -> None:
        ...
        self.inference_scheduler = InferenceScheduler(monitor_id, self.buffer, config.inference_settings or {}, model_registry, app_settings.data_dir / "models", on_result or (lambda *_: None)) if config.inference_settings else None
